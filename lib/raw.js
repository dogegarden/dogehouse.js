...
var socket = socket_io_client_1.io("wss://socket.dogehouse.xyz", { transports: ['websocket'], path: '/socket' });
        ...
        socket.addEventListener("open", function () {
            var heartbeat = setInterval(function () {
                ...
                try {
                    ...
                    console.log('Failed to send ping to API. Is it down? Do you have the latest package version?');
                }
                logger("out", "ping");
            }, heartbeatInterval);
